...
//      Tab      Q        W        E        R        T        Y        U        I        O        P        [        ]        \                 Win + Shift + s
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,          LSG(KC_S),
        KC_ESC,  HOME_A,   HOME_S,   HOME_D,   HOME_F,   KC_G,    KC_H,    HOME_J,   HOME_K,   HOME_L,   HOME_SCLN,KC_QUOT,          KC_ENT,           KC_WHOM,
